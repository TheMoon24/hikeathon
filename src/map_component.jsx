...
function MapComponent({ position, zones, landmarks }) {
  const [markers, setMarkers] = useState([
    {
      ...
      radius: 100, // Default radius for the marker circle
    },
  ]);
  ...
  return (
    <div style={{ position: 'relative', border: '2px solid white', borderRadius: '8px', overflow: 'hidden', margin: '20px' }}>
      ...
      <MapContainer 
        center={[51.505, -0.09]} 
        zoom={13} 
        style={{ height: "80vh", width: "100%", boxSizing: 'border-box' }}
      >
        <TileLayer
